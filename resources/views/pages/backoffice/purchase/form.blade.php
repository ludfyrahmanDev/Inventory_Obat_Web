                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Tanggal Kadaluarsa<span class="tx-danger">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-text">
                                            <div class="input-group-text">
                                                <i class="typcn typcn-calendar-outline tx-24 lh--9 op-6"></i>
                                        ...
                                        <input type="text" class="form-control fc-datepicker" placeholder="Tanggal Kadaluarsa" value="{{ $data->expired_date == '' ? old('expired_date') : $data->expired_date }}" name="expired_date">
                                    </div>
                                    @error('expired_date')
                                        <ul class="parsley-errors-list filled" id="parsley-id-5">
                                            <li class="parsley-required">{{ $message }}</li>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="{{ $data->purchase_price == '' ? old('purchase_price') : $data->purchase_price }}" class="form-control @error('purchase_price') parsley-error @enderror" name='purchase_price' placeholder="Harga Jual" type="number">
