                    ...
                    <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                        <div class="card-sigin">
                            <div class="mb-5 d-flex">
                                ...
                                <h1 class="main-logo1 ms-1 me-0 my-auto tx-28">Inventory <span>OB</span>AT</h1>
                            </div>
                            <div class="card-sigin">
                                <div class="main-signup-header">
                                    <h2>Selamat Data di Inventory Obat</h2>
                                    <h5 class="fw-semibold mb-4">Please sign in to continue.</h5>
                                    <form method="POST" action="{{ route('login') }}">
                                        @csrf
                                        <div class="form-group">
                                            <label>Username</label>
                                            <input class="form-control" name="email" @error('email') is-invalid @enderror placeholder="Enter your username" type="text" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                            @error('email')
