...
class SellingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.backoffice.selling.index', compact('data', 'title'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.backoffice.selling.form', compact('title', 'data','suppliers', 'obat'));
    }
    ...
    public function print($id)
    {
        ...
        $pdf = \PDF::loadView('pages.backoffice.selling.pdf', compact('data', 'title'));
    ...
    public function report(Request $request){
        ...
        return view('pages.backoffice.selling.report', compact('data', 'title', 'suppliers','date','reject_weight_presentase', 'supplier_id', 'date','filter_date'));
    }
    ...
    public function allPrint(Request $request){
        ...
        $pdf = \PDF::loadView('pages.backoffice.selling.allpdf', compact('data', 'title', 'suppliers','date','reject_weight_presentase', 'supplier_id', 'date','filter_date','supplier'));
    ...
    public function show($id)
    {
        ...
        $data->detail = $detail;
        $title = 'Detail Data Penjualan';
        return view('pages.backoffice.selling.show', compact('data', 'title'));
    }
    ...
    public function edit($id)
    {
        ...
        $data->type = 'edit';
        return view('pages.backoffice.selling.form', compact('data', 'title','suppliers', 'categories'));
    }
